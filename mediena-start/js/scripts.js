function updateCalculations () {
    ...
    let lentos = parseInt(document.getElementById('kiekis').value)
    document.querySelector('.kiekis-info').innerText = lentos

    let kubai = storis * plotis * ilgis * lentos * 0.000000001
